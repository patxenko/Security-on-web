...
function registrarUserWeb(){
$.ajax({
	                url:   'registrarSocial.php',
...
<div data-role="content">
			<div class="ui-field-contain">
				<br>
                                <h2 align="center">You are not registered.</h2>
                                <h4 align="center"> If you register in our wegpage, you will be able to configure extra security measures on your account profile. If not, you just can be able to watch the content.</h4>
 <h5 align="center">Choose a password for this site to end with registration</h5>
				<input type="password" id="passUser" type="javascript;" placeholder="******"><br>

			</div><br><br><br>
<div align="center" border-style="solid;" border-color="#000000;">
<INPUT type="submit" href="javascript:;" onclick="registrarUserWeb($('#passUser').val());return false;" data-inline="true" value="REGISTER" class="" style="background: #D4A76B;"/><br>
<br><br><br>
</div>
